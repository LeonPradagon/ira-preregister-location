...
export const envSchema = z.object({
  ...
  FWA_COVERAGE_BASE_URL: optionalUrl,
  FWA_COVERAGE_API_KEY: optionalString,
  FWA_COVERAGE_TIMEOUT_MS: z.coerce.number().int().positive().default(10000),
  FWA_COVERAGE_BATCH_SIZE: z.coerce.number().int().positive().max(1000).default(100),
  ...
  GEOCODING_PRIMARY: z.enum(['GOOGLE', 'OSM']).default('OSM'),
  ...
  EXPORT_STORAGE_DIR: optionalString,
  EXPORT_JOB_TTL_HOURS: z.coerce.number().int().positive().default(24),
  EXPORT_WORKER_CONCURRENCY: z.coerce.number().int().positive().max(4).default(1),
