...
export const customerAddresses = pgTable('customer_addresses', {
  ...
  coordinateAuditStatus: varchar('coordinate_audit_status', { length: 16 }).notNull().default('PENDING'),
  coordinateAuditReason: text('coordinate_audit_reason'),
  coordinateAuditEvidence: jsonb('coordinate_audit_evidence'),
  coordinateAuditConfidence: numeric('coordinate_audit_confidence', { precision: 4, scale: 3 }),
  coordinateAuditedAt: timestamp('coordinate_audited_at', { withTimezone: true }),
