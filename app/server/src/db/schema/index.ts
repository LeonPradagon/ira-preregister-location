...
export const validationResults = pgTable('validation_results', {
  ...
  distanceToReferenceMeters: numeric('distance_to_reference_meters', { precision: 12, scale: 2 }).notNull(),
  ...
  referenceLatitude: numeric('reference_latitude', { precision: 10, scale: 7 }).notNull(),
  referenceLongitude: numeric('reference_longitude', { precision: 10, scale: 7 }).notNull(),
  createdAt: createdAt(),
});
